...
/**
 * Mudei aqui
 * Implementa o contrato de persistência
 * <code>MercadoriaDAO</code>, para resolver o cadastro da entidade
 * <code>Mercadoria</code>.
 *
 * <p>A integração com o banco de dados e o envio dos comandos SQL ocorre
 * através da API do
 * <code>Spring JDBC</code>.</p>
 *
 * <p>O
 * <code>Spring JDBC</code> é um componente do
 * <code>Spring Framework</code>.</p>
 *
...
public class MercadoriaDAOSpring implements MercadoriaDAO {
    ...
    /**
     * Componente
     * <code>Spring</code> que encapsula as operações JDBC.
     */
